...
namespace AIS_LAB6.DataBase
{
    public class DataBaseContext: DbContext
    {
        ...
        public DbSet<Models.TPUDirectionOfTraining> TPUDirectionsOfTraining { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Models.TPUSchool>().HasMany(p => p.DirectionsOfTraining).WithOptional(p => p.School).HasForeignKey(p => p.SchoolId);
            modelBuilder.Entity<Models.TPUDirectionOfTraining>().Property(p => p.Id).HasMaxLength(8);
            modelBuilder.Entity<Models.TPUDirectionOfTraining>().ToTable("TPUDirectionsOfTraining");
        }
    }
}
